...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__28650){
var map__28652 = p__28650;
var map__28652__$1 = ((cljs.core.seq_QMARK_.call(null,map__28652))?cljs.core.apply.call(null,cljs.core.hash_map,map__28652):map__28652);
var opts = map__28652__$1;
var retry_count = cljs.core.get.call(null,map__28652__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__28652__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__28652__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__28652__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
var temp__4420__auto__ = figwheel.client.socket.get_websocket_imp.call(null);
if(cljs.core.truth_(temp__4420__auto__)){
var WebSocket = temp__4420__auto__;
...
socket.onmessage = ((function (url,socket,WebSocket,temp__4420__auto__,map__28652,map__28652__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (msg_str){
var temp__4422__auto__ = cljs.reader.read_string.call(null,msg_str.data);
if(cljs.core.truth_(temp__4422__auto__)){
var msg = temp__4422__auto__;
figwheel.client.utils.debug_prn.call(null,msg);

var and__18108__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__18108__auto__){
var and__18108__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__18108__auto____$1)){
var and__18108__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
...
});})(url,socket,WebSocket,temp__4420__auto__,map__28652,map__28652__$1,opts,retry_count,retried_count,websocket_url,build_id))
;

socket.onopen = ((function (url,socket,WebSocket,temp__4420__auto__,map__28652,map__28652__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__4420__auto__,map__28652,map__28652__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
var retried_count__$1 = (function (){var or__18120__auto__ = retried_count;
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__4420__auto__,map__28652,map__28652__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__4420__auto__,map__28652,map__28652__$1,opts,retry_count,retried_count,websocket_url,build_id))
,(function (){var x__18439__auto__ = (10000);
var y__18440__auto__ = ((2000) + ((500) * retried_count__$1));
return ((x__18439__auto__ < y__18440__auto__) ? x__18439__auto__ : y__18440__auto__);
})());
} else {
return null;
}
...
socket.onerror = ((function (url,socket,WebSocket,temp__4420__auto__,map__28652,map__28652__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
